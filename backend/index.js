...
// Placing the new order and update holdings
app.post("/newOrder", async (req, res) => {
  ...
  if (mode === "BUY") {
    ...
    return res.send("Buy order placed and holdings updated!");
  }
  ...
  if (mode === "SELL") {
    ...
    return res.send("Sell order placed and holdings updated!");
  }

  res.status(400).json({ error: "Invalid order mode" });
});
