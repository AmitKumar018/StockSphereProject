...
function Hero() {
  return (
    <section className="container-fluid" id="supportHero" style={{backgroundColor:"#1E90FF", color:"white"}}>
      ...
      <div className="row p-5 m-3">
        <div className="col-6 p-3">
          ...
          <br />
          <a href="" style={{color:"white"}}>Track account openin </a>
        ...
        <div className="col-6 p-3">
          ...
          <ol>
            <li>
              <a href="" style={{color:"white"}}>Current Takeovers and Delisting - January 2025</a>
            </li>
            <li>
